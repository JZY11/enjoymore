...
import com.ipubu.boot.skills.enjoymore.es.util.EsPage;
...
/**
 * @ClassName AbstractElasticsearchService
 * @Description	
 * @Author jzy
 */
...
public abstract class AbstractElasticsearchService {
     ...
     * @return
     */
    public EsPage searchDataPage(String index, String type, int startPage, int pageSize,
        ...
        if (searchResponse.status().getStatus() == 200) {
            ...
            List<Map<String, Object>> sourceList =
                    setSearchResponse(searchResponse, highlightField);
     ...
     * @return
     */
    public List<Map<String, Object>> searchListData(String index, String type,
                                                    QueryBuilder query, Integer size, String fields, String sortField,
